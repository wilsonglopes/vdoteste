...
// --- COMPONENTES ESPECÍFICOS PARA "MÉTODO FERRADURA" ---
import QuestionStepFerradura from '../components/tarot/QuestionStepFerradura'; 
import SelectionStepFerradura, { CardData } from '../components/tarot/SelectionStepFerradura';
import ReadingStepFerradura from '../components/tarot/ReadingStepFerradura';

// --- CONFIGURAÇÃO ---
const READING_TYPE = 'metodo_ferradura'; 
const CARD_LIMIT = 7; // Limite fixo de 7 cartas
const LOCAL_KEY = 'vozes_tarot_ferradura_v1'; 
  ...
  const startReveal = async () => {
    ...
    try {
      ...
      try {
        ...
        const contextQuestion = `[MÉTODO: FERRADURA (7 CARTAS)] ${question}`;
