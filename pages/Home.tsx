...
const Home: React.FC<HomeProps> = ({ user }) => {
  ...
  return (
    <>
      {/* Wrapper SEM background próprio */}
      <div className="w-full flex flex-col items-center justify-center min-h-[70vh] gap-12 px-4">
        ...
        <div className="text-center space-y-4 animate-fade-in">
          ...
          <p className="text-slate-400 max-w-lg mx-auto font-light leading-relaxed">
            Conecte-se com sua sabedoria interior. Consulte as cartas sagradas ou
            revele as mensagens escondidas em seus sonhos.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
          ...
          <div className="group relative">
            <div className="absolute -inset-0.5 bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl opacity-30 group-hover:opacity-70 transition duration-500 blur" />
          ...
          {/* CARD 2 */}
          <div className="group relative">
            <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl opacity-30 group-hover:opacity-70 transition duration-500 blur" />
