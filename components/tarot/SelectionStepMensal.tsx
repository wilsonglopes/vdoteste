...
interface SelectionStepMensalProps {
...
const SelectionStepMensal: React.FC<SelectionStepMensalProps> = ({
  availableCards,
  selectedCards,
  hoveredCardId,
  setHoveredCardId,
...
export default SelectionStepMensal;
