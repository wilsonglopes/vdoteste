...
interface SelectionStepFerraduraProps {
  ...
  onBack: () => void;
  isMobile: boolean;
  limit: number; // Receberá 7
}

const SelectionStepFerradura: React.FC<SelectionStepFerraduraProps> = ({
  availableCards,
  selectedCards,
  hoveredCardId,
  setHoveredCardId,
...
export default SelectionStepFerradura;
