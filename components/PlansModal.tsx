...
// Importa apenas o script carregador
...
const PlansModal: React.FC<PlansModalProps> = ({ isOpen, onClose }) => {
  ...
  // Carrega o SDK JS puro (mais estável que o React Brick)
  useEffect(() => {
    const loadSDK = async () => {
  ...
  const handleBuy = async (plan: any) => {
    ...
    try {
      ...
      if (data.preferenceId) {
        // --- AQUI ESTÁ A MÁGICA ---
        // Em vez de redirecionar ou abrir o componente bugado,
        // usamos o checkout oficial abrindo "por cima" do site.
        const mp = new window.MercadoPago('APP_USR-b1f663d0-5d18-4458-b345-e7889fcdaaa7', {
          locale: 'pt-BR'
        });
        ...
        mp.checkout({
          ...
          autoOpen: true, // Abre o modal do MP automaticamente
        });

        // Fecha o nosso modal de planos para focar no pagamento
        setLoading(null);
